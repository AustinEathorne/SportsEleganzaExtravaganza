...
[CustomEditor(typeof(BreathingTextButton))]
public class BreathingTextButtonEditor : Editor
{
    // Foldout bools
    ...
    public override void OnInspectorGUI()
    {
        ...
        BreathingTextButton myTarget = (BreathingTextButton)target;
        ...
        if (this.showComponents)
        {
            ...
            EditorList.Show(serializedObject.FindProperty("textList"), EditorListOptions.ListLabel | EditorListOptions.Buttons);
            serializedObject.ApplyModifiedProperties();
