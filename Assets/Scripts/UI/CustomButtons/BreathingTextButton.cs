...
public class BreathingTextButton : CustomTextButton
{
    // On
    ...
    // Off
    public float fadeOutTime;//off
    public float pressedScaleAwayTime;//off
    ...
    {
        this.transformList[0].transform.localScale = Vector3.zero;
        this.transformList[1].transform.localScale = Vector3.zero;

        this.textList[0].color = new Color(this.idleColours[0].r, this.idleColours[0].g, this.idleColours[0].b, 0.0f);
        this.textList[1].color = new Color(this.idleColours[1].r, this.idleColours[1].g, this.idleColours[1].b, 0.0f);
    ...
    protected override IEnumerator IdleState()
    {
        ...
        UIUtility.Instance.StartCoroutine(UIUtility.Instance.ShiftListColours(this.textList, this.idleColours, this.colorShiftTime, true));

        float elapsedTime = 0.0f;

        Coroutine scale = UIUtility.Instance.StartCoroutine(UIUtility.Instance.ScaleListOverTime(this.transformList, this.minScale, this.scaleDownTime, true, true));
        ...
        {
            elapsedTime = 0.0f;
            scale = UIUtility.Instance.StartCoroutine(UIUtility.Instance.ScaleListOverTime(this.transformList, this.maxScale, this.scaleUpTime, true, true));
